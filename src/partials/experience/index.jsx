...
It retrieves experience post data from the MDX files and passes it through context to other components
...
// Renders a preview card for each experience post
const Post = ({ data }) => {
  ...
  // Populates the experience post card with passed tags
  ...
  return (
    <div css={styled.PostsList}>
      <Row>
        ...
        >
          {/* Map over each experience post and embed it in slider */}
